...
- **[Stackboard](https://github.com/creativoma/stackboard)** — A focused, Trello-style board for one team managing one shared project — Next.js App Router, Server Actions, and Postgres via Drizzle ORM.
- **[Auto Claude](https://github.com/creativoma/auto-claude)** — A small, auditable bash loop that runs Claude Code unattended against a queue of tasks, gated by a verification command.
