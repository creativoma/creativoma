...
**Languages:**
TypeScript, JavaScript, Ruby, HTML5, CSS3, SQL, PHP

**Frameworks:**
React, Next.js, Astro, Angular, Ruby on Rails, Hotwire

**UI & Motion:**
TailwindCSS, Framer Motion, GSAP, Three.js, React Three Fiber, PIXI.js, tldraw

**State & Data:**
Zustand, SWR, TanStack Query, tRPC, Zod, i18next, Inertia.js

**Backend & DB:**
Node.js, Express, Prisma, PostgreSQL, MySQL, MongoDB

**Tooling:**
Git, Docker, AWS, Vercel, Turborepo, Figma, Jest, Vitest, Playwright

**AI:**
Claude API, OpenAI, Gemini, Vercel AI SDK, MCP servers

### Links that might be of interest:

- [Personal Website](https://marianoalvarez.dev/)
- [npm Packages](https://www.npmjs.com/~creativoma)
- [linkedin.com/in/ma-marianoalvarez](https://www.linkedin.com/in/ma-marianoalvarez/)
- [hello@marianoalvarez.dev](mailto:hello@marianoalvarez.dev)
- [buymeacoffee.com/creativoma](https://buymeacoffee.com/creativoma)
